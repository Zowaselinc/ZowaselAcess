...
>
                        ...
                        <div class="col">
                            ...
                            <input
v-model="farmer.fertilizers"
type="text"
class="form-control"
required
name="fertilizers"
placeholder="Enter fertilizers"
>
                        </div></div></div>
                        ...
                        <div class="col">
                            ...
                            <input
v-model="farmer.herbicides"
type="text"
class="form-control"
required
name="herbicides"
placeholder="Enter herbicides"
>
                        </div>
                        ...
                        <div class="col">
                            ...
                            <input
v-model="farmer.fungicides"
type="text"
class="form-control"
required
name="fungicides"
placeholder="Enter fungicides"
>
                        </div></div></div>
                        ...
                        <div class="col">
                            ...
                            <input
v-model="farmer.insecticides"
type="text"
class="form-control"
required
name="insecticides"
placeholder="Enter insecticides"
>
                        </div>
