...
>           
<router-link
                :to="{ name: 'Farmers', params: { id: farmer.id } }"
            >
                <button
type="button"
class="btn btn-success btn-sm"
...
<router-link
                :to="{ name: 'Transfer', params: { id: farmer.id } }"
            >
                <button
type="button"
...
export default {
  ...
  mounted() {
    axios.get(`${baseUrl}/transfer/status=Accepted`).then((response) => {
...
created() {
  ...
  methods: {
      getFarmers() {
    axios.get(`${baseUrl}/transfer/status=Accepted`)
      .then((res) => {
